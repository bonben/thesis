...
\usepackage{scalerel}
%\def\thumbsup{\scalerel*{\includegraphics{head/down.png}}{400pt}}
%\def\thumbsdown{\scalerel*{\includegraphics{head/up.png}}{400pt}}
%\def\thumbsmid{\scalerel*{\includegraphics{head/mid.png}}{400pt}}
...
\renewcommand{\algorithmicrequire}{\textbf{\emph{Variables :}}}
