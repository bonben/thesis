...
\begin{tikzpicture}
	...
	\node[es_a] (find) at (-3, -4.5) {Identification/Tri $q$ \textbf{symboles} les moins fiables};
	\node[es_a] (save) at (-3, -5.5) {Sauvegarde des $q$ deuxièmes symboles les plus probables};
