...
\include{head/dedication}          % Dédicace du document.
\include{head/thanks}     % Remerciements.
\include{head/abstracts}      % Résumé du sujet en français.
...
\include{head/symbols}       % Liste des sigles et abréviations.
\ifthenelse{\equal{\AnnexesPresentes}{O}}{\listofappendices}{}
\mainmatter
\include{main/intro}       % Introduction au sujet de recherche.
\include{main/ch1}             % Premier thème (Doctorat) ou "Détails de la Solution" (Maîtrise).
\include{main/ch2}             % Second thème (Doctorat) ou "Résultats théoriques et expérimentaux" (Maîtrise).
\include{main/ch3}             % Troisième thème (Doctorat) ou effacez ce fichier si vous êtes à la Maîtrise.
\include{main/ch4}             % Troisième thème (Doctorat) ou effacez ce fichier si vous êtes à la Maîtrise.
\include{main/conclu}         % Conclusion.
%\backmatter
\ifthenelse{\equal{\Langue}{english}}{
