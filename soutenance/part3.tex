...
\begin{frame}[c,noframenumbering]{Deux modèles de conception d'ASIP}
  \centering
...
\begin{frame}[c]{Comparison avec des architectures matérielles dédiées}
    \begin{itemize}
      \item<+-> Transport Triggered Transport Decoder
    ...
    \only<1>{
      ...
      \centering
      {
        ...
        \begin{tabular}{C{3cm}|C{3cm}|C{2cm}|C{2cm}|C{2cm}}
          ...
          \textbf{Cible}         &  Stratix IV       & Stratix IV            & Stratix IV         & Virtex 6             \\
          \textbf{RAM} (Kb)       &  141           & 43                    & 36                 & 36                   \\
          \textbf{LUTS}           &  19664         & 23020                 & 24821              & 22115                \\
          \textbf{\'Elagage}        &  R0 \& R1      & Full                  & Full               & Full                 \\
    ...
    \only<3>{
      ...
      \centering
      {
        ...
        \begin{tabular}{C{3cm}|C{3cm}|C{2cm}|C{2cm}|C{2cm}}
          ...
          \textbf{Cible}         &  \BLUE{Stratix IV}       & \textbf{Stratix IV}            & \textbf{Stratix IV }        & \textbf{Virtex 6}             \\
          \textbf{RAM} (Kb)       &  141           & 43                    & 36                 & 36                   \\
          \textbf{LUTS}           &  19664         & 23020                 & 24821              & 22115                \\
          \textbf{\'Elagage}        &  R0 \& R1      & Full                  & Full               & Full                 \\
          \textbf{Cycles d'horloge}   &  1161          & 222                   & 165                & 165                  \\
...
\begin{frame}[c,noframenumbering]{Comparison with dedicated hardware decoders}
    \begin{itemize}
    ...
    \only<2>{
      ...
      \centering
      {
        ...
        \begin{tabular}{C{3cm}|C{3cm}|C{2cm}|C{2cm}|C{2cm}}
          ...
          \textbf{Cible}         &  Stratix IV        & Stratix IV             & Stratix IV          & Virtex 6              \\
          \textbf{RAM} (Kb)       &  141            & 43                     & 36                  & 36                    \\
          \textbf{LUTS}           &  \textbf{19664} & \textbf{23020}         & \textbf{24821}      & \textbf{22115}        \\
          \textbf{\'Elagage}        &  R0 \& R1       & Full                   & Full                & Full                  \\
          \textbf{Cycles d'horloge}   &  1161           & 222                    & 165                 & 165                   \\
    ...
    \only<3>{
      ...
      \centering
      {
        ...
        \begin{tabular}{C{3cm}|C{3cm}|C{2cm}|C{2cm}|C{2cm}}
          ...
          \textbf{RAM} (Kb)       &  141           & 43                    & 36                 & 36                   \\
          \textbf{LUTS}           &  19664         & 23020                 & 24821              & 22115                \\
          \textbf{\'Elagage}        &  \textbf{R0 \& R1}      & \textbf{Full}                  & \textbf{Full}               & \textbf{Full}                 \\
          \textbf{Cycles d'horloge}   &  1161          & 222                   & 165                & 165                  \\
