...
\begin{frame}[c]{Codage polaire}
	\multiinclude[<+>][start=1,format=pdf,graphics={width=.8\textwidth}]{./fig/focus_polar}
\end{frame}
...
\begin{frame}[c]{Algorithme de décodage SC}
	\multiinclude[<+>][start=1,end=2,format=pdf,graphics={width=.8\textwidth}]{./fig/focus_decoder}
\end{frame}

\begin{frame}[c]{Algorithme de décodage SC}
	\multiinclude[<+>][start=1,format=pdf,graphics={width=.35\textwidth}]{./fig/polar_functions}
\end{frame}
...
\begin{frame}[c]{Algorithme de décodage SCL}
	\multiinclude[<+>][start=1,format=pdf,graphics={width=.7\textwidth}]{./fig/scl_anim}
\end{frame}
