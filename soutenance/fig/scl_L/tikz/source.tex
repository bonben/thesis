...
\begin{tikzpicture}
  \begin{semilogyaxis}[/pgfplots/table/ignore chars={|}, %footnotesize,
    ...
    % \addplot[mark=diamond , Set1-2, semithick, dashed    , mark options={solid}] table [x=Eb/N0, y=FER] {../dat/SCL_2.txt};          \label{plot:line2}
    % \addplot[mark=star    , Set1-2, semithick, dashed    , mark options={solid}] table [x=Eb/N0, y=FER] {../dat/SCL_4.txt};          \label{plot:line3}
    % \addplot[mark=square  , Set1-2, semithick, dashed    , mark options={solid}] table [x=Eb/N0, y=FER] {../dat/SCL_8.txt};          \label{plot:line4}
    \addplot[mark=triangle, Set1-2, semithick, dashed    , mark options={solid}] table [x=Eb/N0, y=FER] {../dat/SCL_32.txt};         \label{plot:line5}
    % \addplot[mark=star    , Set1-3, semithick, dashdotted, mark options={solid}] table [x=Eb/N0, y=FER] {../dat/SCL_4_CRC_16.txt};  \label{plot:line6}
    % \addplot[mark=square  , Set1-3, semithick, dashdotted, mark options={solid}] table [x=Eb/N0, y=FER] {../dat/SCL_8_CRC_16.txt};  \label{plot:line7}
