...
\caption{Performances de décodage de l'algorithme SCL pour un code polaire (2048,1723). Différentes valeurs de $L$, et une courbe de comparaison à l'algorithme CA-SCL}
\label{fig:scl_l}
\end{figure}

% Rajouter des références à des cas précis
