...
\begin{figure}[t]
  \renewcommand*\thesubfigure{\arabic{subfigure}} 
  \centering
  \subfloat[][Initialisation]{\includegraphics[width=.26\textwidth]{main/ch1_fig/scan_graph_1}}\quad\quad\quad
  \subfloat[][$f_{bp}$ function]{\includegraphics[width=.18\textwidth]{main/ch1_fig/scan_graph_2}}\\
  \subfloat[][$g_{bp}$ function]{\includegraphics[width=.18\textwidth]{main/ch1_fig/scan_graph_3}}\quad\quad\quad
  \subfloat[][Backward functions]{\includegraphics[width=.18\textwidth]{main/ch1_fig/scan_graph_4}}
