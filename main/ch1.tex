...
\begin{figure}[t]
  ...
  \subfloat[][Fonction $f$]{\includegraphics[width=.18\textwidth]{main/ch1_fig/sc_graph_2}}\quad\quad
  \subfloat[][Fonction $\texttt{R0}$]{\includegraphics[width=.2\textwidth]{main/ch1_fig/sc_graph_3}}\\
  \subfloat[][Fonction $g$]{\includegraphics[width=.18\textwidth]{main/ch1_fig/sc_graph_4}}\quad\quad
  \subfloat[][Fonction $\texttt{R1}$]{\includegraphics[width=.2\textwidth]{main/ch1_fig/sc_graph_5}}\quad\quad
  \subfloat[][Fonction $h$]{\includegraphics[width=.18\textwidth]{main/ch1_fig/sc_graph_6}}
...
\subsection*{Synthèse sur les différents algorithmes de décodage.}
