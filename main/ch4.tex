...
Le réseau d'interconnexion possède deux bus de 512 bits pour le transport des LLRs, un bus de 64 bits pour le transport des sommes partielles, et deux bus de 32 bits pour le transport des données génériques et des adresses.
Dans la section suivante, certaines des FUs sont détaillées.

\subsection{Unités fonctionnelles du décodeur \texttt{TT-SC}.}
Nous allons détailler ici la fonction et l'implémentation matérielle de certaines des FUs. Certaines (GCU, ALU, LSU, RF) sont liées au fonctionnement du base du TTA et à ce titre ne sont pas pertinentes ici. D'autres (LLR PU, PS PU) sont très similaires aux instructions spécialisées de l'architecture de processeur XTensa du Chapitre \ref{chap:tensilica}, décrites dans la sous-section \ref
{subsec:multi_reg}.

Les unités fonctionnelles originales spécifiques à cette architecture sont les unités de chargement et de sauvegarde vectorielles d'une part, et l'unité \og SC déroulé \fg d'autre part.
...
\begin{table}[t]
  ...
  \begin{tabular}{rccccc}
   \toprule
    ...
    \textbf{Target}         &  Artix-7  & Stratix IV            & Stratix IV          & Virtex 6               \\ % & Artix-7             \\
    \textbf{Clock cycles}   &  1161     & 222                   & 165                 & 165                    \\ % & 1161                \\
    \textbf{IT}/P (Mb/s)    &  44       & 238                   & 319                 & 217                    \\ % & 44                  \\
    \textbf{Freq} (MHz)     &  100      & 103                   & 103                 & 70                     \\ % & 100                 \\
    \textbf{LUTS}           &  14744    & 23020                 & 24821               & 22115                  \\ % & 17352               \\
    \textbf{FFs}            &  7354     & 1024                  & 5823                & 7941                   \\ % & 7354                \\
    \textbf{RAM} (Kb)       &  1368     & 43                    & 36                  & 36                     \\ % & 141                 \\
    \textbf{Pruning}        &  R0 \& R1 & Full                  & Full                & Full                   \\ % & R0 \& R1            \\
    \bottomrule   
  \end{tabular}  
\end{table}
