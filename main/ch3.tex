...
\begin{figure}[t]
  ...
  \includegraphics[width=0.51\textwidth]{main/ch3_fig/methodo_b}
  \label{fig:methodo_a}
  }
  \quad
  \subfloat[Flot basé sur la spécification complète du processeur.]{
  \includegraphics[width=0.4075\textwidth]{main/ch3_fig/methodo_a}
  \label{fig:methodo_b}
  }
