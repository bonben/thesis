...
La Figure \ref{fig:ccsds_fnc} présente les performances de l'algorithme FNC cette fois dans le contexte d'un turbo code 
...
\begin{figure}[!htb]
	...
	Décodeurs itérant jusqu'à 10 fois. \label{fig:fnc_lte}}
\end{figure}
