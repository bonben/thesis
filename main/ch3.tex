...
{
\chapter{Conception d'un processeur par la spécialisation de son architecture} % (fold)
...
+ pseudo déroulage                                & $151.00\times10^3$  &   $163$            & $445500$             \\
    \end{tabular}
    }}
  \end{table}
...
\section{Synthèse et limites du modèle architectural}
