...
\end{axis}
  ...
  \node [align=left, text width=5.4cm] at (2.5,-1.4) {(a): Cycle count and ratio for a code rate of 1/2} ;
  \node [align=left, text width=5.4cm] at (8.5,-1.4) {(b): Cycle count and ratio for a code rate of 1/4};
