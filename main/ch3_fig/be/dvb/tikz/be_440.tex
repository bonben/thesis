...
\begin{tikzpicture}
    ...
    clip=false 
		...
		\nextgroupplot[ylabel=BE - FdM (\%), legend entries = {1.2dB, 1.6dB, 2.0dB}]
		...
		\nextgroupplot[ylabel=SE - FdM (\%), legend entries = {1.2dB, 1.6dB, 2.0dB}]
		...
		\addplot[mark=*, only marks, black, mark options={scale=0.9, fill=Dark2-2!50 }, update limits=false] table[x=X, y=13_se] {../dat/th440_w};
 		...
 		\nextgroupplot[ylabel=BE - FdM (\%), legend entries = {1.6dB, 2.0dB, 2.4dB}]
		...
		\nextgroupplot[ylabel=SE - FdM (\%), legend entries = {1.6dB, 2.0dB, 2.4dB}]
		...
		\nextgroupplot[ylabel=BE - FdM (\%), legend entries = {3.2dB, 3.6dB, 4.0dB}]
		...
		\nextgroupplot[ylabel=SE - FdM (\%), legend entries = {3.2dB, 3.6dB, 4.0dB}]
		...
		\nextgroupplot[ylabel=BE - FdM (\%), legend entries = {4.4dB, 4.8dB, 5.2dB}]
		...
		\nextgroupplot[ylabel=SE - FdM (\%), legend entries = {4.4dB, 4.8dB, 5.2dB}]
...
\end{groupplot}
		...
		\node[below = 0.9cm] at ($(be c1r1.south)!0.5!(be c2r1.south)$)  {(a) : DVB-RCS - K=440 R=1/3};
		\node[below = 0.9cm] at ($(be c1r2.south)!0.5!(be c2r2.south)$)  {(b) : DVB-RCS - K=440 R=1/2};
		\node[below = 0.9cm] at ($(be c1r3.south)!0.5!(be c2r3.south)$)  {(c) : DVB-RCS - K=440 R=3/4};
		\node[below = 0.9cm] at ($(be c1r4.south)!0.5!(be c2r4.south)$)  {(d) : DVB-RCS - K=440 R=6/7};
