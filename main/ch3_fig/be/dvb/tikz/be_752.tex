...
\begin{tikzpicture}
		...
		\begin{groupplot}[group style={group name=be, group size= 2 by 4, horizontal sep=1.7cm, vertical sep=2.5cm}, 
...
\end{groupplot}
		\node[below = 0.7cm of be c1r1.south] {(a) : DVB-RCS - K=752 R=1/3 - BE};
		\node[below = 0.7cm of be c2r1.south] {(b) : DVB-RCS - K=752 R=1/3 - SE};
		\node[below = 0.7cm of be c1r2.south] {(c) : DVB-RCS - K=752 R=1/2 - BE};
		\node[below = 0.7cm of be c2r2.south] {(d) : DVB-RCS - K=752 R=1/2 - SE};
		\node[below = 0.7cm of be c1r3.south] {(e) : DVB-RCS - K=752 R=3/4 - BE};
		\node[below = 0.7cm of be c2r3.south] {(f) : DVB-RCS - K=752 R=3/4 - SE};
		\node[below = 0.7cm of be c1r4.south] {(g) : DVB-RCS - K=752 R=6/7 - BE};
		\node[below = 0.7cm of be c2r4.south] {(h) : DVB-RCS - K=752 R=6/7 - SE};
\end{tikzpicture}  
