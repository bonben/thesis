...
\begin{tikzpicture}
    ...
    clip=false
		 ...
		 \addplot[mark=*, only marks, black, mark options={scale=0.9, fill=Dark2-2!50 }, update limits=false] table[x=X, y=l528] {../dat/th};
		 ...
		 \addplot[mark=*, only marks, black, mark options={scale=0.9, fill=Dark2-2!50 }, update limits=false] table[x=X, y=l1024] {../dat/th};
		 ...
		 \addplot[draw=Paired-5, fill=Paired-5!50, postaction={pattern color = black!80,pattern=crosshatch dots }] table [x=X, y expr=\thisrowno{7}/5] {../dat/1504.dat};
 		 ...
 		 \addplot[mark=*, only marks, black, mark options={scale=0.9, fill=Dark2-2!50 }, update limits=false] table[x=X, y=l1504] {../dat/th};
 		 \addplot [<-, black, very thin, sharp plot, update limits=false] coordinates{(3.95,60) (4.4,60)} node [right] {{\footnotesize $68$}};
		 ...
		 \addplot[mark=*, only marks, black, mark options={scale=0.9, fill=Dark2-2!50 }, update limits=false] table[x=X, y=l2048] {../dat/th};
		 ...
		 \node[rotate=60] at ($(axis cs:22.1,49)+(0,0)$) {\small \textcolor{Paired-1}{53}};
 		 ...
 		 \addplot[mark=*, only marks, black, mark options={scale=0.9, fill=Dark2-2!50 }, update limits=false] table[x=X, y=l6144] {../dat/th};
		...
		\addplot[draw=Paired-5, fill=Paired-5!50, postaction={pattern color = black!80,pattern=crosshatch dots}] table [x=X, y expr=\thisrowno{4}] {../dat/ccsds_my.dat};
		\node[rotate=60] at ($(axis cs:22.1,49)+(0,0)$) {\small \textcolor{Paired-1}{62}};
		\addplot[mark=*, only marks, black, mark options={scale=0.9, fill=Dark2-2!50 }, update limits=false] table[x=X, y=ccsds] {../dat/th};
		\addplot [<-, black, very thin, sharp plot, update limits=false] coordinates{(2.95,60) (3.4,60)} node [right] {{\footnotesize $48$}};
				
\end{groupplot}
		\node[below = 0.8cm of be c1r1.south] {(a) : LTE K=528 - R=1/3};
        \node[below = 0.8cm of be c2r1.south] {(b) : LTE K=1024 - R=1/3};
		\node[below = 0.8cm of be c1r2.south] {(c) : LTE K=1504 - R=1/3};
        \node[below = 0.8cm of be c2r2.south] {(d) : LTE K=2048 - R=1/3};
        \node[below = 0.8cm of be c1r3.south] {(e) : LTE K=6144 - R=1/3};
        \node[below = 0.8cm of be c2r3.south] {(f) : CCSDS K=1784 - R=1/3};
\end{tikzpicture}
