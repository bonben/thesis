...
\begin{tikzpicture}
    \begin{semilogyaxis}[footnotesize, width=.45\textwidth, height=.35\textwidth,    
       ...
       % legend pos=north east, %yticklabels={,,},
        ...
        \addplot[mark=o,Dark2-4, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m4_M4.txt};
        \addplot[mark=o,Dark2-5, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m5_M5.txt};
        \addplot[mark=o,Dark2-6, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m6_M6.txt};
        \addplot[mark=o,Dark2-7, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m7_M7.txt};
...
\begin{tikzpicture}
    \begin{semilogyaxis}[footnotesize, width=\textwidth, height=0.6\textwidth,    
        ...
        \addplot[mark=o,Dark2-2, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m2_M2.txt};
        \addplot[mark=o,Dark2-3, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m3_M3.txt};
        \addplot[mark=o,Dark2-4, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m4_M4.txt};
        \addplot[mark=o,Dark2-5, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m5_M5.txt};
        \addplot[mark=o,Dark2-6, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m6_M6.txt};
        \addplot[mark=o,Dark2-7, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m7_M7.txt};
        \addplot[mark=o,purple, semithick]  table [x=Eb/N0, y=FER] {../2048/fnc10_m8.txt};
