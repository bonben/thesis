...
\begin{document}
        ...
        \begin{tikzpicture}
                ...
                \begin{groupplot}[group style={group name=ccsds, group size= 1 by 2, horizontal sep=2cm, vertical sep=2.2cm}, 
                                    ...
                                    ymin=0, ymax=0.6, %ytick = {0,1000,...,10000},
                ...
                \nextgroupplot[]
                        \addplot[fill=correctbit!50] table [x=R, y=NNC] {../stats/ccsds_2/610-7/dist.dat}; 
                        \addplot[fill=correctbit]  table [x=R, y=IIC] {../stats/ccsds_2/610-7/dist.dat}; 
                        \addplot[fill=falsebit!50]  table [x=R, y=NNE] {../stats/ccsds_2/610-7/dist.dat}; 
                        \addplot[fill=falsebit]  table [x=R, y=IIE] {../stats/ccsds_2/610-7/dist.dat};  
            ...
            \nextgroupplot[]
                        \addplot[fill=correctbit!50] table [x=R, y=NIC] {../stats/ccsds_2/610-7/dist.dat}; 
                        \addplot[fill=correctbit]  table [x=R, y=NIC] {../stats/ccsds_2/610-7/dist.dat}; 
                        \addplot[fill=falsebit!50]  table [x=R, y=NIE] {../stats/ccsds_2/610-7/dist.dat}; 
                        \addplot[fill=falsebit]  table [x=R, y=INE] {../stats/ccsds_2/610-7/dist.dat};  
