...
\begin{document}
        ...
        \begin{tikzpicture}
                ...
                \begin{groupplot}[group style={group name=lte, group size= 1 by 2, horizontal sep=2cm, vertical sep=2.2cm}, 
                                    ...
                                    ymin=0, ymax=0.3, %ytick = {0,1000,...,10000},
                ...
                \nextgroupplot[]
                        \addplot[fill=correctbit!50] table [x=R, y=NNC] {../stats/lte_2/10-2/dist.dat}; 
                        \addplot[fill=correctbit]  table [x=R, y=IIC] {../stats/lte_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit!50]  table [x=R, y=NNE] {../stats/lte_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit]  table [x=R, y=IIE] {../stats/lte_2/10-2/dist.dat};  
            ...
            \nextgroupplot[]
                        \addplot[fill=correctbit!50] table [x=R, y=NIC] {../stats/lte_2/10-2/dist.dat}; 
                        \addplot[fill=correctbit]  table [x=R, y=NIC] {../stats/lte_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit!50]  table [x=R, y=NIE] {../stats/lte_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit]  table [x=R, y=INE] {../stats/lte_2/10-2/dist.dat};  
