...
\begin{document}
        ...
        \begin{tikzpicture}
                ...
                \begin{groupplot}[group style={group name=ccsds, group size= 1 by 2, horizontal sep=2cm, vertical sep=2.2cm}, 
                                    ...
                                    ymin=0, ymax=20, %ytick = {0,1000,...,10000},
                ...
                \nextgroupplot[]
                        \addplot[fill=correctbit!50] table [x=R,  y expr=\thisrow{NNC}*100] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=correctbit]  table [x=R,  y expr=\thisrow{IIC}*100] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit!50]  table [x=R,  y expr=\thisrow{NNE}*100] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit]  table [x=R,  y expr=\thisrow{IIE}*100] {../stats/ccsds_2/10-2/dist.dat};  
            ...
            \nextgroupplot[]
                        \addplot[fill=correctbit!50] table [x=R,  y expr=\thisrow{NIC}*100] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=correctbit]  table [x=R,  y expr=\thisrow{INC}*100] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit!50]  table [x=R,  y expr=\thisrow{NIE}*100] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit]  table [x=R,  y expr=\thisrow{INE}*100] {../stats/ccsds_2/10-2/dist.dat};  
