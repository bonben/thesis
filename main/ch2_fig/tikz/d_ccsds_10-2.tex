...
\begin{document}
        ...
        \begin{tikzpicture}
                ...
                \nextgroupplot[]
                        \addplot[fill=correctbit!50] table [x=R, y=NNC] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=correctbit]  table [x=R, y=IIC] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit!50]  table [x=R, y=NNE] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit]  table [x=R, y=IIE] {../stats/ccsds_2/10-2/dist.dat};  
            ...
            \nextgroupplot[]
                        \addplot[fill=correctbit!50] table [x=R, y=NIC] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=correctbit]  table [x=R, y=NIC] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit!50]  table [x=R, y=NIE] {../stats/ccsds_2/10-2/dist.dat}; 
                        \addplot[fill=falsebit]  table [x=R, y=INE] {../stats/ccsds_2/10-2/dist.dat};  
